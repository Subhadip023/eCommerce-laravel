<x-app-layout>
    ...
    <section class="text-gray-600 body-font">
        ...
        <form action="{{ route('role.store') }}" method="POST" class="flex flex-col items-center justify-center">
            @csrf
            <div class="container px-5 py-24 mx-auto flex flex-wrap items-center">

                <div
                    class="lg:w-2/6 md:w-1/2 bg-gray-300 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 mx-auto">
                    <h2 class="text-gray-900 text-lg font-medium title-font mb-5">Add Role Form </h2>
